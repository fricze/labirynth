...
declare function beginScissorMode(
  x: number,
  y: number,
  width: number,
  height: number,
...
declare function loadShader(
  vsFileName: string | undefined | null,
  fsFileName: string | undefined | null,
): Shader;
/** Load shader from code strings and bind default locations */
declare function loadShaderFromMemory(
  vsCode: string | undefined | null,
  fsCode: string | undefined | null,
): Shader;
/** Check if a shader is ready */
declare function isShaderReady(shader: Shader): boolean;
/** Get shader uniform location */
declare function getShaderLocation(
  shader: Shader,
  uniformName: string | undefined | null,
): number;
/** Get shader attribute location */
declare function getShaderLocationAttrib(
  shader: Shader,
  attribName: string | undefined | null,
): number;
/** Set shader uniform value */
declare function setShaderValue(
  shader: Shader,
  locIndex: number,
  value: any,
  uniformType: number,
...
declare function setShaderValueMatrix(
  shader: Shader,
  locIndex: number,
  mat: Matrix,
): void;
/** Set shader uniform value for texture (sampler2d) */
declare function setShaderValueTexture(
  shader: Shader,
  locIndex: number,
  texture: Texture,
): void;
...
declare function getScreenToWorld2D(
  position: Vector2,
  camera: Camera2D,
): Vector2;
/** Get size position for a 3d world space position */
declare function getWorldToScreenEx(
  position: Vector3,
  camera: Camera3D,
  width: number,
  height: number,
...
declare function getWorldToScreen2D(
  position: Vector2,
  camera: Camera2D,
): Vector2;
...
declare function saveFileData(
  fileName: string | undefined | null,
  data: any,
  bytesToWrite: number,
): boolean;
/** Load text data from file (read), returns a '\0' terminated string */
declare function loadFileText(
  fileName: string | undefined | null,
): string | undefined | null;
/** Save text data to file (write), string must be '\0' terminated, returns true on success */
declare function saveFileText(
  fileName: string | undefined | null,
  text: string | undefined | null,
): boolean;
...
declare function isFileExtension(
  fileName: string | undefined | null,
...
declare function getFileNameWithoutExt(
  filePath: string | undefined | null,
): string | undefined | null;
/** Get full path for a given fileName with path (uses static string) */
declare function getDirectoryPath(
  filePath: string | undefined | null,
): string | undefined | null;
/** Get previous directory path for a given path (uses static string) */
declare function getPrevDirectoryPath(
...
declare function loadDirectoryFiles(
  dirPath: string | undefined | null,
): string[];
/** Load directory filepaths with extension filtering and recursive directory scan */
declare function loadDirectoryFilesEx(
...
declare function isGamepadButtonPressed(
  gamepad: number,
  button: number,
): boolean;
...
declare function isGamepadButtonReleased(
  gamepad: number,
  button: number,
): boolean;
...
declare function setGamepadMappings(
  mappings: string | undefined | null,
): number;
...
declare function updateCameraPro(
  camera: Camera3D,
  movement: Vector3,
  rotation: Vector3,
  zoom: number,
...
declare function drawLineV(
  startPos: Vector2,
  endPos: Vector2,
  color: Color,
): void;
/** Draw a line defining thickness */
declare function drawLineEx(
  startPos: Vector2,
  endPos: Vector2,
  thick: number,
  color: Color,
...
declare function drawLineBezier(
  startPos: Vector2,
  endPos: Vector2,
  thick: number,
  color: Color,
...
declare function drawLineBezierQuad(
  startPos: Vector2,
  endPos: Vector2,
  controlPos: Vector2,
  thick: number,
...
declare function drawLineBezierCubic(
  startPos: Vector2,
  endPos: Vector2,
...
declare function drawCircleSector(
  center: Vector2,
  radius: number,
  startAngle: number,
  endAngle: number,
...
declare function drawCircleSectorLines(
  center: Vector2,
  radius: number,
  startAngle: number,
  endAngle: number,
...
declare function drawCircleGradient(
  centerX: number,
  centerY: number,
  radius: number,
  color1: Color,
...
declare function drawCircleV(
  center: Vector2,
  radius: number,
  color: Color,
): void;
/** Draw circle outline */
declare function drawCircleLines(
  centerX: number,
  centerY: number,
  radius: number,
  color: Color,
...
declare function drawEllipseLines(
  centerX: number,
  centerY: number,
  radiusH: number,
  radiusV: number,
...
/** Draw ring outline */
declare function drawRingLines(
  center: Vector2,
  innerRadius: number,
  outerRadius: number,
  startAngle: number,
...
declare function drawRectangleV(
  position: Vector2,
  size: Vector2,
  color: Color,
): void;
...
declare function drawRectanglePro(
  rec: Rectangle,
  origin: Vector2,
  rotation: number,
  color: Color,
...
declare function drawRectangleGradientV(
  posX: number,
  posY: number,
  width: number,
  height: number,
...
declare function drawRectangleGradientH(
  posX: number,
  posY: number,
  width: number,
  height: number,
...
declare function drawRectangleGradientEx(
  rec: Rectangle,
  col1: Color,
  col2: Color,
  col3: Color,
...
declare function drawRectangleLines(
  posX: number,
  posY: number,
  width: number,
  height: number,
...
declare function drawRectangleLinesEx(
  rec: Rectangle,
  lineThick: number,
  color: Color,
): void;
/** Draw rectangle with rounded edges */
declare function drawRectangleRounded(
  rec: Rectangle,
  roundness: number,
  segments: number,
  color: Color,
...
declare function drawTriangleLines(
  v1: Vector2,
  v2: Vector2,
  v3: Vector2,
  color: Color,
...
declare function drawPolyLines(
  center: Vector2,
  sides: number,
  radius: number,
  rotation: number,
...
declare function drawPolyLinesEx(
  center: Vector2,
  sides: number,
  radius: number,
  rotation: number,
...
declare function checkCollisionCircles(
  center1: Vector2,
  radius1: number,
  center2: Vector2,
  radius2: number,
...
declare function checkCollisionCircleRec(
  center: Vector2,
  radius: number,
  rec: Rectangle,
): boolean;
/** Check if point is inside rectangle */
declare function checkCollisionPointRec(
  point: Vector2,
  rec: Rectangle,
): boolean;
/** Check if point is inside circle */
declare function checkCollisionPointCircle(
  point: Vector2,
  center: Vector2,
  radius: number,
): boolean;
/** Check if point is inside a triangle */
declare function checkCollisionPointTriangle(
  point: Vector2,
  p1: Vector2,
  p2: Vector2,
  p3: Vector2,
...
declare function checkCollisionPointLine(
  point: Vector2,
  p1: Vector2,
  p2: Vector2,
  threshold: number,
...
declare function exportImage(
  image: Image,
  fileName: string | undefined | null,
): boolean;
/** Generate image: plain color */
declare function genImageColor(
  width: number,
  height: number,
  color: Color,
): Image;
/** Generate image: linear gradient, direction in degrees [0..360], 0=Vertical gradient */
declare function genImageGradientLinear(
  width: number,
  height: number,
  direction: number,
  start: Color,
...
declare function genImageGradientRadial(
  width: number,
  height: number,
  density: number,
  inner: Color,
...
declare function genImageGradientSquare(
  width: number,
  height: number,
  density: number,
  inner: Color,
...
declare function genImageChecked(
  width: number,
  height: number,
  checksX: number,
  checksY: number,
...
declare function genImageWhiteNoise(
  width: number,
  height: number,
  factor: number,
): Image;
/** Generate image: perlin noise */
declare function genImagePerlinNoise(
  width: number,
  height: number,
  offsetX: number,
  offsetY: number,
...
declare function genImageCellular(
  width: number,
  height: number,
  tileSize: number,
): Image;
/** Generate image: grayscale image from text data */
declare function genImageText(
  width: number,
  height: number,
  text: string | undefined | null,
): Image;
...
declare function imageText(
  text: string | undefined | null,
  fontSize: number,
  color: Color,
): Image;
/** Create an image from text (custom sprite font) */
declare function imageTextEx(
  font: Font,
  text: string | undefined | null,
  fontSize: number,
  spacing: number,
...
declare function imageAlphaClear(
  image: Image,
  color: Color,
  threshold: number,
): void;
...
declare function imageResize(
  image: Image,
  newWidth: number,
  newHeight: number,
): void;
/** Resize image (Nearest-Neighbor scaling algorithm) */
declare function imageResizeNN(
  image: Image,
  newWidth: number,
  newHeight: number,
): void;
/** Resize canvas and fill with color */
declare function imageResizeCanvas(
  image: Image,
  newWidth: number,
  newHeight: number,
  offsetX: number,
...
declare function imageColorReplace(
  image: Image,
  color: Color,
  replace: Color,
): void;
...
declare function getImageAlphaBorder(
  image: Image,
  threshold: number,
): Rectangle;
...
declare function imageDrawPixel(
  dst: Image,
  posX: number,
  posY: number,
  color: Color,
...
declare function imageDrawPixelV(
  dst: Image,
  position: Vector2,
  color: Color,
): void;
/** Draw line within an image */
declare function imageDrawLine(
  dst: Image,
  startPosX: number,
  startPosY: number,
  endPosX: number,
...
declare function imageDrawLineV(
  dst: Image,
  start: Vector2,
  end: Vector2,
  color: Color,
...
declare function imageDrawCircle(
  dst: Image,
  centerX: number,
  centerY: number,
  radius: number,
...
declare function imageDrawCircleV(
  dst: Image,
  center: Vector2,
  radius: number,
  color: Color,
...
declare function imageDrawCircleLines(
  dst: Image,
  centerX: number,
  centerY: number,
  radius: number,
...
declare function imageDrawCircleLinesV(
  dst: Image,
  center: Vector2,
  radius: number,
  color: Color,
...
declare function imageDrawRectangle(
  dst: Image,
  posX: number,
  posY: number,
  width: number,
...
declare function imageDrawRectangleV(
  dst: Image,
  position: Vector2,
  size: Vector2,
  color: Color,
...
/** Draw rectangle within an image */
declare function imageDrawRectangleRec(
  dst: Image,
  rec: Rectangle,
  color: Color,
): void;
/** Draw rectangle lines within an image */
declare function imageDrawRectangleLines(
  dst: Image,
  rec: Rectangle,
  thick: number,
  color: Color,
...
declare function imageDrawText(
  dst: Image,
  text: string | undefined | null,
  posX: number,
  posY: number,
...
declare function imageDrawTextEx(
  dst: Image,
  font: Font,
  text: string | undefined | null,
  position: Vector2,
...
declare function loadRenderTexture(
  width: number,
  height: number,
): RenderTexture;
...
declare function updateTextureRec(
  texture: Texture,
  rec: Rectangle,
  pixels: any,
): void;
...
declare function drawTextureV(
  texture: Texture,
  position: Vector2,
  tint: Color,
): void;
/** Draw a Texture2D with extended parameters */
declare function drawTextureEx(
  texture: Texture,
  position: Vector2,
  rotation: number,
  scale: number,
...
declare function drawTextureRec(
  texture: Texture,
  source: Rectangle,
  position: Vector2,
  tint: Color,
...
declare function drawTexturePro(
  texture: Texture,
  source: Rectangle,
  dest: Rectangle,
  origin: Vector2,
...
declare function drawTextureNPatch(
  texture: Texture,
...
declare function getPixelDataSize(
  width: number,
  height: number,
  format: number,
): number;
...
declare function loadFontEx(
  fileName: string | undefined | null,
  fontSize: number,
): Font;
/** Load font from Image (XNA style) */
declare function loadFontFromImage(
  image: Image,
  key: Color,
  firstChar: number,
): Font;
...
declare function drawTextCodepoint(
  font: Font,
  codepoint: number,
  position: Vector2,
  fontSize: number,
...
declare function measureTextEx(
  font: Font,
  text: string | undefined | null,
  fontSize: number,
  spacing: number,
...
/** Draw a color-filled triangle (vertex in counter-clockwise order!) */
declare function drawTriangle3D(
  v1: Vector3,
  v2: Vector3,
  v3: Vector3,
  color: Color,
...
declare function drawCubeV(
  position: Vector3,
  size: Vector3,
  color: Color,
): void;
/** Draw cube wires */
declare function drawCubeWires(
  position: Vector3,
  width: number,
  height: number,
  length: number,
...
declare function drawCubeWiresV(
  position: Vector3,
  size: Vector3,
  color: Color,
): void;
/** Draw sphere */
declare function drawSphere(
  centerPos: Vector3,
  radius: number,
  color: Color,
): void;
/** Draw sphere with extended parameters */
declare function drawSphereEx(
  centerPos: Vector3,
  radius: number,
  rings: number,
  slices: number,
...
/** Draw sphere wires */
declare function drawSphereWires(
  centerPos: Vector3,
  radius: number,
  rings: number,
  slices: number,
...
declare function drawCylinderEx(
  startPos: Vector3,
  endPos: Vector3,
  startRadius: number,
  endRadius: number,
...
declare function drawCylinderWires(
  position: Vector3,
  radiusTop: number,
  radiusBottom: number,
  height: number,
...
declare function drawCylinderWiresEx(
  startPos: Vector3,
  endPos: Vector3,
  startRadius: number,
  endRadius: number,
...
declare function drawCapsuleWires(
  startPos: Vector3,
  endPos: Vector3,
  radius: number,
  slices: number,
...
declare function drawModelWires(
  model: Model,
  position: Vector3,
  scale: number,
  tint: Color,
...
declare function drawModelWiresEx(
  model: Model,
  position: Vector3,
  rotationAxis: Vector3,
  rotationAngle: number,
...
declare function drawBillboard(
  camera: Camera3D,
  texture: Texture,
  position: Vector3,
  size: number,
...
declare function drawBillboardRec(
  camera: Camera3D,
  texture: Texture,
  source: Rectangle,
  position: Vector3,
...
declare function drawBillboardPro(
  camera: Camera3D,
  texture: Texture,
  source: Rectangle,
  position: Vector3,
...
declare function updateMeshBuffer(
  mesh: Mesh,
  index: number,
  data: any,
  dataSize: number,
...
declare function drawMesh(
  mesh: Mesh,
  material: Material,
  transform: Matrix,
): void;
/** Draw multiple mesh instances with material and different transforms */
declare function drawMeshInstanced(
  mesh: Mesh,
  material: Material,
  transforms: Matrix,
  instances: number,
...
declare function genMeshCube(
  width: number,
  height: number,
  length: number,
): Mesh;
/** Generate sphere mesh (standard sphere) */
declare function genMeshSphere(
  radius: number,
  rings: number,
  slices: number,
): Mesh;
/** Generate half-sphere mesh (no bottom cap) */
declare function genMeshHemiSphere(
  radius: number,
  rings: number,
  slices: number,
): Mesh;
/** Generate cylinder mesh */
declare function genMeshCylinder(
  radius: number,
  height: number,
  slices: number,
): Mesh;
/** Generate cone/pyramid mesh */
declare function genMeshCone(
  radius: number,
  height: number,
  slices: number,
): Mesh;
/** Generate torus mesh */
declare function genMeshTorus(
  radius: number,
  size: number,
  radSeg: number,
  sides: number,
...
declare function setMaterialTexture(
  material: Material,
  mapType: number,
  texture: Texture,
): void;
/** Set material for a mesh */
declare function setModelMeshMaterial(
  model: Model,
  meshId: number,
  materialId: number,
): void;
/** Check collision between two spheres */
declare function checkCollisionSpheres(
  center1: Vector3,
  radius1: number,
  center2: Vector3,
  radius2: number,
...
declare function checkCollisionBoxes(
  box1: BoundingBox,
  box2: BoundingBox,
): boolean;
/** Check collision between box and sphere */
declare function checkCollisionBoxSphere(
  box: BoundingBox,
  center: Vector3,
  radius: number,
): boolean;
/** Get collision info between ray and sphere */
declare function getRayCollisionSphere(
  ray: Ray,
  center: Vector3,
  radius: number,
): RayCollision;
...
declare function getRayCollisionMesh(
  ray: Ray,
  mesh: Mesh,
  transform: Matrix,
): RayCollision;
/** Get collision info between ray and triangle */
declare function getRayCollisionTriangle(
  ray: Ray,
  p1: Vector3,
  p2: Vector3,
  p3: Vector3,
...
declare function getRayCollisionQuad(
  ray: Ray,
  p1: Vector3,
  p2: Vector3,
  p3: Vector3,
...
declare function loadWaveFromMemory(
  fileType: string | undefined | null,
  fileData: ArrayBuffer,
  dataSize: number,
): Wave;
...
declare function waveCrop(
  wave: Wave,
  initSample: number,
  finalSample: number,
): void;
/** Convert wave data to desired format */
declare function waveFormat(
  wave: Wave,
  sampleRate: number,
  sampleSize: number,
  channels: number,
...
declare function vector2MoveTowards(
  v: Vector2,
  target: Vector2,
  maxDistance: number,
): Vector2;
...
declare function vector2ClampValue(
  v: Vector2,
  min: number,
  max: number,
): Vector2;
...
declare function vector3RotateByAxisAngle(
  v: Vector3,
  axis: Vector3,
  angle: number,
): Vector3;
...
declare function vector3Barycenter(
  p: Vector3,
  a: Vector3,
  b: Vector3,
  c: Vector3,
...
declare function vector3Unproject(
  source: Vector3,
  projection: Matrix,
  view: Matrix,
): Vector3;
...
declare function vector3ClampValue(
  v: Vector3,
  min: number,
  max: number,
): Vector3;
...
declare function matrixFrustum(
  left: number,
  right: number,
  bottom: number,
  top: number,
...
declare function matrixPerspective(
  fovY: number,
  aspect: number,
  nearPlane: number,
  farPlane: number,
...
declare function quaternionLerp(
  q1: Vector4,
  q2: Vector4,
  amount: number,
): Vector4;
/** Calculate slerp-optimized interpolation between two quaternions */
declare function quaternionNlerp(
  q1: Vector4,
  q2: Vector4,
  amount: number,
): Vector4;
/** Calculates spherical linear interpolation between two quaternions */
declare function quaternionSlerp(
  q1: Vector4,
  q2: Vector4,
  amount: number,
): Vector4;
/** Calculate quaternion based on the rotation from one vector to another */
declare function quaternionFromVector3ToVector3(
  from: Vector3,
  to: Vector3,
): Vector4;
...
declare function quaternionFromEuler(
  pitch: number,
  yaw: number,
  roll: number,
): Vector4;
...
/**  */
declare function cameraMoveForward(
  camera: Camera3D,
  distance: number,
...
/**  */
declare function cameraMoveRight(
  camera: Camera3D,
  distance: number,
  moveInWorldPlane: boolean,
): void;
...
/**  */
declare function cameraYaw(
  camera: Camera3D,
  angle: number,
  rotateAroundTarget: boolean,
): void;
/**  */
declare function cameraPitch(
  camera: Camera3D,
  angle: number,
  lockView: boolean,
  rotateAroundTarget: boolean,
...
/**  */
declare function getCameraProjectionMatrix(
  camera: Camera3D,
  aspect: number,
): Matrix;
...
declare function guiWindowBox(
  bounds: Rectangle,
  title: string | undefined | null,
): boolean;
/** Group Box control with text name */
declare function guiGroupBox(
  bounds: Rectangle,
  text: string | undefined | null,
): void;
/** Line separator control, could contain text */
declare function guiLine(
  bounds: Rectangle,
  text: string | undefined | null,
): void;
/** Panel control, useful to group controls */
declare function guiPanel(
  bounds: Rectangle,
  text: string | undefined | null,
): void;
/** Scroll Panel control */
declare function guiScrollPanel(
  bounds: Rectangle,
  text: string | undefined | null,
  content: Rectangle,
  scroll: Vector2,
...
declare function guiLabel(
  bounds: Rectangle,
  text: string | undefined | null,
): void;
/** Button control, returns true when clicked */
declare function guiButton(
  bounds: Rectangle,
  text: string | undefined | null,
): boolean;
/** Label button control, show true when clicked */
declare function guiLabelButton(
  bounds: Rectangle,
  text: string | undefined | null,
): boolean;
/** Toggle Button control, returns true when active */
declare function guiToggle(
  bounds: Rectangle,
  text: string | undefined | null,
  active: boolean,
): boolean;
/** Toggle Group control, returns active toggle index */
declare function guiToggleGroup(
  bounds: Rectangle,
  text: string | undefined | null,
  active: number,
): number;
/** Check Box control, returns true when active */
declare function guiCheckBox(
  bounds: Rectangle,
  text: string | undefined | null,
  checked: boolean,
): boolean;
/** Combo Box control, returns selected item index */
declare function guiComboBox(
  bounds: Rectangle,
  text: string | undefined | null,
  active: number,
): number;
/** Dropdown Box control, returns selected item */
declare function guiDropdownBox(
  bounds: Rectangle,
  text: string | undefined | null,
...
declare function guiTextBox(
  bounds: Rectangle,
  text: { text: string },
  editMode: boolean,
): boolean;
/** Slider control, returns selected value */
declare function guiSlider(
  bounds: Rectangle,
  textLeft: string | undefined | null,
  textRight: string | undefined | null,
  value: number,
  minValue: number,
  maxValue: number,
): number;
/** Slider Bar control, returns selected value */
declare function guiSliderBar(
  bounds: Rectangle,
  textLeft: string | undefined | null,
  textRight: string | undefined | null,
  value: number,
...
declare function guiProgressBar(
  bounds: Rectangle,
  textLeft: string | undefined | null,
  textRight: string | undefined | null,
  value: number,
...
declare function guiStatusBar(
  bounds: Rectangle,
  text: string | undefined | null,
): void;
/** Dummy control for placeholders */
declare function guiDummyRec(
  bounds: Rectangle,
  text: string | undefined | null,
): void;
/** Grid control, returns mouse cell position */
declare function guiGrid(
  bounds: Rectangle,
  text: string | undefined | null,
  spacing: number,
  subdivs: number,
...
declare function guiListView(
  bounds: Rectangle,
  text: string | undefined | null,
  scrollIndex: { scrollIndex: number },
  active: number,
): number;
/** Message Box control, displays a message */
declare function guiMessageBox(
  bounds: Rectangle,
  title: string | undefined | null,
  message: string | undefined | null,
  buttons: string | undefined | null,
): number;
/** Text Input Box control, ask for text, supports secret */
declare function guiTextInputBox(
  bounds: Rectangle,
  title: string | undefined | null,
  message: string | undefined | null,
  buttons: string | undefined | null,
  text: { text: string },
  secretViewActive: { secretViewActive: number },
): number;
/** Color Picker control (multiple color controls) */
declare function guiColorPicker(
  bounds: Rectangle,
  text: string | undefined | null,
  color: Color,
): Color;
/** Color Panel control */
declare function guiColorPanel(
  bounds: Rectangle,
  text: string | undefined | null,
  color: Color,
): Color;
/** Color Bar Alpha control */
declare function guiColorBarAlpha(
  bounds: Rectangle,
  text: string | undefined | null,
  alpha: number,
): number;
/** Color Bar Hue control */
declare function guiColorBarHue(
  bounds: Rectangle,
  text: string | undefined | null,
  value: number,
): number;
...
declare function easeLinearNone(
  t: number,
  b: number,
  c: number,
  d: number,
...
/** Ease: Linear In */
declare function easeLinearOut(
  t: number,
  b: number,
  c: number,
  d: number,
...
/** Ease: Linear Out */
declare function easeLinearInOut(
  t: number,
  b: number,
  c: number,
  d: number,
...
/** Ease: Sine Out */
declare function easeSineInOut(
  t: number,
  b: number,
  c: number,
  d: number,
...
/** Ease: Circular Out */
declare function easeCircInOut(
  t: number,
  b: number,
  c: number,
  d: number,
...
/** Ease: Cubic Out */
declare function easeCubicInOut(
  t: number,
  b: number,
  c: number,
  d: number,
...
/** Ease: Quadratic Out */
declare function easeQuadInOut(
  t: number,
  b: number,
  c: number,
  d: number,
...
declare function easeExpoInOut(
  t: number,
  b: number,
  c: number,
  d: number,
...
declare function easeBounceOut(
  t: number,
  b: number,
  c: number,
  d: number,
...
/** Ease: Bounce In */
declare function easeBounceInOut(
  t: number,
  b: number,
  c: number,
  d: number,
...
declare function easeElasticIn(
  t: number,
  b: number,
  c: number,
  d: number,
...
/**  */
declare function loadLightmapper(
  w: number,
  h: number,
  mesh: Mesh,
  cfg: LightmapperConfig,
): Lightmapper;
/**  */
declare function loadMaterialLightmapper(
  emissiveColor: Color,
  intensity: number,
): Material;
/**  */
...
declare function setModelMaterial(
  model: Model,
  materialIndex: number,
  material: Material,
): void;
/** Get material in slot materialIndex */
declare function getModelMaterial(
  model: Model,
  materialIndex: number,
): Material;
...
declare function setShaderLocation(
  shader: Shader,
  constant: number,
  location: number,
): void;
